        ...
        public override bool draw (Cairo.Context cr) {
            ...
            for (int i = 0; i < 12; i++) {
                ...
                if (i % 3 == 0) {
                    ...
                    cr.set_line_width (0.4 * cr.get_line_width ());
                }
            ...
            for(int i = 0; i < 60; i++){
                ...
                inset = (int)(radius * 0.1);
                cr.set_line_width(0.1*cr.get_line_width());
                cr.move_to(x + (radius - inset) * Math.cos (i * Math.PI / 30),
                            y + (radius - inset) * Math.sin (i * Math.PI / 30));
                cr.line_to (x + radius * Math.cos (i * Math.PI / 30),
                            y + radius * Math.sin (i * Math.PI / 30));
                cr.stroke ();
            ...
            // minute hand:
            // the minute hand is rotated 6 degrees (pi/30 r) per minute + 0.1 degree (0.1*pi/180 r) per second
            cr.move_to (x, y);
            cr.line_to (x + radius * 0.75 * (Math.sin (Math.PI / 30 * minutes + 0.1*Math.PI/180 * seconds)),
                        y + radius * 0.75 * (-Math.cos (Math.PI / 30 * minutes + 0.1*Math.PI/180  * seconds)));
            cr.stroke ();
                        
            // seconds hand:
            // the minute hand is rotated 6 degrees (pi/30 r) per second
            cr.save ();
